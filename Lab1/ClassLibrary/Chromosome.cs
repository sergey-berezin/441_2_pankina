...
namespace ClassLibrary
{
    public class Chromosome
    {
        ...
        public Chromosome (int citiesCount, double[,] distances)
        {
        ...
        public Chromosome (List<int> route, int citiesCount, double[,] distances)
        {
            this.citiesCount = citiesCount;
        ...
        public Chromosome(List<int> route1, List<int> route2, int citiesCount, double[,] distances)
        {
            this.citiesCount = citiesCount;
            route = new List<int>();
            cross(route1, route2);
